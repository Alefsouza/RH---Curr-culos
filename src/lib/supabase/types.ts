  ...
  public: {
    Tables: {
      ...
      templates_mensagem: {
        ...
        Relationships: [
          {
            foreignKeyName: 'templates_mensagem_etapa_id_fkey'
            columns: ['etapa_id']
            isOneToOne: false
            referencedRelation: 'etapas'
            referencedColumns: ['id']
          ...
          {
            foreignKeyName: 'templates_mensagem_user_id_fkey'
            columns: ['user_id']
            isOneToOne: false
            referencedRelation: 'usuarios'
            referencedColumns: ['id']
...
//   FOREIGN KEY mensagens_whatsapp_template_id_fkey: FOREIGN KEY (template_id) REFERENCES templates_mensagem(id) ON DELETE SET NULL
//   FOREIGN KEY mensagens_whatsapp_user_id_fkey: FOREIGN KEY (user_id) REFERENCES usuarios(id) ON DELETE CASCADE
// Table: templates_mensagem
//   FOREIGN KEY templates_mensagem_etapa_id_fkey: FOREIGN KEY (etapa_id) REFERENCES etapas(id) ON DELETE CASCADE
//   PRIMARY KEY templates_mensagem_pkey: PRIMARY KEY (id)
//   FOREIGN KEY templates_mensagem_user_id_fkey: FOREIGN KEY (user_id) REFERENCES usuarios(id) ON DELETE CASCADE
// Table: usuarios
...
//     WITH CHECK: (auth.uid() = user_id)
// Table: templates_mensagem
//   Policy "templates_mensagem_delete" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: (auth.uid() = user_id)
//   Policy "templates_mensagem_insert" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: (auth.uid() = user_id)
//   Policy "templates_mensagem_select" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (auth.uid() = user_id)
//   Policy "templates_mensagem_update" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: (auth.uid() = user_id)
//     WITH CHECK: (auth.uid() = user_id)
// Table: usuarios
...
//   $function$
//
// FUNCTION sync_analise_to_analise_cv()
...
// Table: analises
//   on_analise_update_sync_cv: CREATE TRIGGER on_analise_update_sync_cv AFTER INSERT OR UPDATE OF resultado ON public.analises FOR EACH ROW EXECUTE FUNCTION sync_analise_to_analise_cv()
...
//   CREATE UNIQUE INDEX idx_analise_cv_unique_cv_vaga ON public.analise_cv USING btree (cv_id, vaga_id)
