  ...
  public: {
    Tables: {
      ...
      candidato_observacoes: {
        ...
        Relationships: [
          {
            foreignKeyName: "candidato_observacoes_candidato_id_fkey"
            columns: ["candidato_id"]
            isOneToOne: false
            referencedRelation: "candidatos"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "candidato_observacoes_usuario_id_fkey"
            columns: ["usuario_id"]
            isOneToOne: false
            referencedRelation: "usuarios"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      normalizar_texto: { Args: { p_text: string }; Returns: string }
      transferir_observacoes_candidato: {
        Args: { p_ativo_id: string; p_duplicado_id: string }
        Returns: undefined
      }
