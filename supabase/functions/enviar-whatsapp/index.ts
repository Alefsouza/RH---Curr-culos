          ...
          payload_body = {
            ...
            buttons: [
              { 
                ...
                type: "reply", 
                reply: { id: `sim_${candidato_id}`, title: (template.botao_sim_texto || 'Sim').substring(0, 20) }
              },
              { 
                id: `nao_${candidato_id}`, 
                text: (template.botao_nao_texto || 'Não').substring(0, 20),
                type: "reply", 
                reply: { id: `nao_${candidato_id}`, title: (template.botao_nao_texto || 'Não').substring(0, 20) }
              }
            ]
          }
        }
