...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    message = message.replace(/{{nome}}/gi, 'Candidato Teste')
    message = message.replace(/{{nome_candidato}}/gi, 'Candidato Teste')
    message = message.replace(/{{vaga}}/gi, 'Vaga Teste')
    ...
    perguntaTexto = perguntaTexto.replace(/{{nome}}/gi, 'Candidato Teste')
    perguntaTexto = perguntaTexto.replace(/{{nome_candidato}}/gi, 'Candidato Teste')
    perguntaTexto = perguntaTexto.replace(/{{vaga}}/gi, 'Vaga Teste')
    perguntaTexto = perguntaTexto.replace(/{{nome_vaga}}/gi, 'Vaga Teste')
    perguntaTexto = perguntaTexto.replace(/{nome_candidato}/gi, 'Candidato Teste')
    perguntaTexto = perguntaTexto.replace(/{nome_vaga}/gi, 'Vaga Teste')
    ...
    if (isChatbot) {
      payload_body = {
        number: numWpp,
        title: message || "Mensagem de Teste",
